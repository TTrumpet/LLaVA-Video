...
from llava.mm_utils import get_model_name_from_path, process_images, tokenizer_image_token, tokenizer_image_and_bbox_token
from llava.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, IGNORE_INDEX, DEFAULT_BBOX_START_TOKEN, DEFAULT_BBOX_END_TOKEN
...
def main(split, pretrained):
    ...
    with open(f'/home/ttran/CAP/datasets/conv_ElysiumTrack-100K-Newton.json') as json_data:
    ...
    for i in range(num_videos):
        ...
        bboxes = data[i]['conversations'][1]['value']
        question = question + " " + DEFAULT_BBOX_START_TOKEN + str(bboxes) + DEFAULT_BBOX_END_TOKEN
