...
DATA_YAML="scripts/video/train/elysium.yaml" # e.g exp.yaml
...
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-ov_to_video_elysium_100K_lora"
