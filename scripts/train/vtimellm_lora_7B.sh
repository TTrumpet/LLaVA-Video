...
PREV_STAGE_CHECKPOINT="work_dirs/llavavideo-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-elysium_100K_lora_a3_merged"
PREV_STAGE_CHECKPOINT="work_dirs/llavavideo-Qwen2-7B_elysium_bbox_merged"
