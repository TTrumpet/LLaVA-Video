...
MID_RUN_NAME="llavavideo-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-vtimellm_50K_lora_a1"
#PREV_STAGE_CHECKPOINT="lmms-lab/LLaVA-Video-7B-Qwen2"
PREV_STAGE_CHECKPOINT="/home/jfioresi/vlm/LLaVA-Video/work_dirs/llavavideo-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-elysium_100K_lora_a1"
...
/lustre/fs1/home/ttran/.conda/envs/llava/bin/deepspeed --master_port 30005 \
