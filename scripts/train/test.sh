...
BASE_RUN_NAME="llavanext-google_siglip-so400m-patch14-384-Qwen_Qwen2.5-3B-Instruct-mlp2x_gelu-pretrain_blip558k_plain"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"

# Stage 2
PROMPT_VERSION="qwen_1_5"
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-ov_to_video_test"
PREV_STAGE_CHECKPOINT="Qwen/Qwen2.5-3B-Instruct"
