...
IMAGE_FOLDER="X"
VIDEO_FOLDER="/datasets/WebVid/data/videos"
DATA_YAML="scripts/data/elysium.yaml" # e.g exp.yaml
...
MID_RUN_NAME="llavavideo-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-elysium_100K_lora_32f_a1"
