    ...
    for source in sources:
        for sentence in source:
            ...
            if DEFAULT_IMAGE_TOKEN in sentence["value"]:
                ...
                replace_token = ""
                if not vision_config == None and vision_config.slow_token:
...
if __name__ == "__main__":
    ...
    # If using non-pretrained models
    #vid_start_token_id = tokenizer.convert_tokens_to_ids('<vid_start>')
    #if not hasattr(model.config, 'vid_start_token'):
    #    model.config.vid_start_token = vid_start_token_id
